...
export default function EmptyState() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center px-6">
      <div className="w-12 h-12 rounded-2xl bg-surface0 flex items-center justify-center mb-4">
        ...
        <div className="space-y-2 w-full max-w-[280px]">
          {SUGGESTIONS.map((s, i) => (
            <button
              ...
              className="w-full text-left text-xs text-subtext1 bg-surface0 hover:bg-surface1 rounded-xl px-3 py-2.5 transition-colors border border-transparent hover:border-surface2"
            >
              {s}
            </button>
          ))}
